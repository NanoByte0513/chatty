...
Status linear_fp16(cublasHandle_t handle, const __half* x, const __half* weight, const float* bias, float* out, int m, int k, int n);
 ...
 * * @return chatty::Status.
 */
Status linear_w8fp16(cublasHandle_t handle, const __half* x, const int8_t* weight, const __half* bias, __half* out, int m, int k, int n);
Status linear_w8fp16(cublasHandle_t handle, const __half* x, const int8_t* weight, const float* bias, __half* out, int m, int k, int n);
 ...
 * * @return chatty::Status.
 */
Status linear_w8a16(cublasHandle_t handle, const int16_t* x, const int8_t* weight, const __half* bias, int16_t* out, int m, int k, int n);
Status linear_w8a16(cublasHandle_t handle, const int16_t* x, const int8_t* weight, const float* bias, int16_t* out, int m, int k, int n);
 ...
 * * @return chatty::Status.
 */
Status linear_w8a8(cublasHandle_t handle, const int8_t* x, const int8_t* weight, const __half* bias, int8_t* out, int m, int k, int n);
Status linear_w8a8(cublasHandle_t handle, const int8_t* x, const int8_t* weight, const float* bias, int8_t* out, int m, int k, int n);
