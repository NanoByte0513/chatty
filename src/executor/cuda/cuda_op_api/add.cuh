...
// Status add(cublasHandle_t handle, float alpha=1.0f, const Tensor& x, float beta=1.0f, const Tensor& y, Tensor& out);

// Status add_fp16(cublasHandle_t handle, float alpha=1.0f, const __half* x, float beta=1.0f, const __half* y, __half* out, int m, int n);
// Status add_fp32(cublasHandle_t handle, float alpha=1.0f, const float* x, float beta=1.0f, const float* y, float* out, int m, int n);
